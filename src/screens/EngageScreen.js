  ...
  const [postsList, setPostsList] = useState([
    {
      ...
      likes: 124,
      time: '2h',
      content: 'Truly honored to be back on campus for the RVEI Alumni Gala. The growth of our network is incredible! Inspiring to see the next generation of leaders. #RVCE #AlumniMeet',
    },
    {
      id: '2',
      user: 'Ananya Joshi',
      ...
      likes: 89,
      time: '5h',
      content: 'Our Silicon Valley RVEI chapter is hosting a meetup next month. Anyone in the Bay Area, please join us for coffee and mentorship talks! ☕️ #Mentorship #BayArea',
    },
  ]);
