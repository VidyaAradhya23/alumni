...
export const API_URL = process.env.EXPO_PUBLIC_API_URL || (process.env.NODE_ENV === 'production' ? 'https://backend-six-dusky-31.vercel.app/api' : 'http://192.168.30.142:5000/api');
